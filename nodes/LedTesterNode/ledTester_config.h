#ifndef LED_TESTER_CONFIG_H
#define LED_TESTER_CONFIG_H
...
#define COLD_LED_PWM_PIN                    10 /* cold LED PWM control pin */
...
#define WARM_LED_PWM_PIN                    5 /* warm LED PWM control pin */
